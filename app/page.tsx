...
const ToDelete = () => {
  return (
    <main className="space-y-6">
      ...
      <Prose>
        <h1>
          <Balancer>Ավտոմեքենաների վերանորոգում և սպասարկում</Balancer>
        </h1>

        <p>
          Մենք առաջարկում ենք Ավտոմեքենաների և շարժիչների վերանորոգման բարձրակարգ ծառայություններ:
          Էլեկտրական համակարգերի վերականգնում, ծրագրային ապահովման թարմացում
          և ամբողջական ախտորոշում՝ Ձեր մեքենայի հուսալի աշխատանքի համար:
        </p>
      </Prose>
